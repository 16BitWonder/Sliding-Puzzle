...
--=================================================================================--
	...
	--Load all images
	one = love.graphics.newImage('3x3/1.png')   -- Load piece one
	two = love.graphics.newImage('3x3/2.png')   -- Load piece two
	three = love.graphics.newImage('3x3/3.png') -- Load piece three
	four = love.graphics.newImage('3x3/4.png')  -- Load piece four
	five = love.graphics.newImage('3x3/5.png')  -- Load piece five
	six = love.graphics.newImage('3x3/6.png')   -- Load piece six
	seven = love.graphics.newImage('3x3/7.png') -- Load piece seven
	eight = love.graphics.newImage('3x3/8.png') -- Load piece eight
	nine = love.graphics.newImage('3x3/9.png')  -- Load piece nine
