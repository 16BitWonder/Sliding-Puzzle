...
--=================================================================================--
	...
	--Load all images
	one = love.graphics.newImage('4x4/1.png')   -- Load piece one
	two = love.graphics.newImage('4x4/2.png')   -- Load piece two
	three = love.graphics.newImage('4x4/3.png') -- Load piece three
	four = love.graphics.newImage('4x4/4.png')  -- Load piece four
	five = love.graphics.newImage('4x4/5.png')  -- Load piece five
	six = love.graphics.newImage('4x4/6.png')   -- Load piece six
	seven = love.graphics.newImage('4x4/7.png') -- Load piece seven
	eight = love.graphics.newImage('4x4/8.png') -- Load piece eight
	nine = love.graphics.newImage('4x4/9.png')  -- Load piece nine
	ten = love.graphics.newImage('4x4/10.png')  -- Load piece ten
	eleven = love.graphics.newImage('4x4/11.png')  -- Load piece eleven
	twelve = love.graphics.newImage('4x4/12.png')  -- Load piece twelve
	thirteen = love.graphics.newImage('4x4/13.png')  -- Load piece thirteen
	fourteen = love.graphics.newImage('4x4/14.png')  -- Load piece fourteen
	fifteen = love.graphics.newImage('4x4/15.png')  -- Load piece fifteen
	sixteen = love.graphics.newImage('4x4/16.png')  -- Load piece sixteen
