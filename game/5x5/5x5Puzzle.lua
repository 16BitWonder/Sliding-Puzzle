...
--=================================================================================--
	...
	--Load all images
	one = love.graphics.newImage('5x5/1.png')   -- Load piece one
	two = love.graphics.newImage('5x5/2.png')   -- Load piece two
	three = love.graphics.newImage('5x5/3.png') -- Load piece three
	four = love.graphics.newImage('5x5/4.png')  -- Load piece four
	five = love.graphics.newImage('5x5/5.png')  -- Load piece five
	six = love.graphics.newImage('5x5/6.png')   -- Load piece six
	seven = love.graphics.newImage('5x5/7.png') -- Load piece seven
	eight = love.graphics.newImage('5x5/8.png') -- Load piece eight
	nine = love.graphics.newImage('5x5/9.png')  -- Load piece nine
	ten = love.graphics.newImage('5x5/10.png')  -- Load piece ten
	eleven = love.graphics.newImage('5x5/11.png')  -- Load piece eleven
	twelve = love.graphics.newImage('5x5/12.png')  -- Load piece twelve
	thirteen = love.graphics.newImage('5x5/13.png')  -- Load piece thirteen
	fourteen = love.graphics.newImage('5x5/14.png')  -- Load piece fourteen
	fifteen = love.graphics.newImage('5x5/15.png')  -- Load piece fifteen
	sixteen = love.graphics.newImage('5x5/16.png')  -- Load piece sixteen
	seventeen = love.graphics.newImage('5x5/17.png')  -- Load piece seventeen
	eightteen = love.graphics.newImage('5x5/18.png')  -- Load piece eightteen
	nineteen = love.graphics.newImage('5x5/19.png')  -- Load piece nineteen
	twenty = love.graphics.newImage('5x5/20.png')  -- Load piece twenty
	twentyone = love.graphics.newImage('5x5/21.png')  -- Load piece twenty-one
	twentytwo = love.graphics.newImage('5x5/22.png')  -- Load piece twenty-two
	twentythree = love.graphics.newImage('5x5/23.png')  -- Load piece twenty-three
	twentyfour = love.graphics.newImage('5x5/24.png')  -- Load piece twenty-four
	twentyfive = love.graphics.newImage('5x5/25.png')  -- Load piece twenty-five
